...
namespace Shears.Logging
{
    ...
    public static class ISHLoggableExtensions
    {
        ...
        public static void Log(this ISHLoggable logger, string message, SHLogLevel level = SHLogLevel.Log, Color color = default, Object context = null, string prefix = "", ISHLogFormatter formatter = default,
