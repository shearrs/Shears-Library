...
{
    /// <summary>
    /// Represents a formattable log for use by the <see cref="KBLogger"/>.
    /// </summary>
    [System.Serializable]
    public struct KBLog
    {
        ...
        /// </summary>
        public KBLogLevel Level { readonly get => _level; set => _level = value; }
        ...
        #region Caller Info
        /// <summary>
        /// The file path of the caller who logged this log. For use by the <see cref="KBLogger"/>.
        /// </summary>
        internal string CallerFilePath { readonly get => _callerFilePath; set => _callerFilePath = value; }

        /// <summary>
        /// The line number of the caller who logged this log. For use by the <see cref="KBLogger"/>.
        /// </summary>
        internal long CallerLineNumber { readonly get => _callerLineNumber; set => _callerLineNumber = value; }

        /// <summary>
        /// The file name of the caller who logged this log. For use by the <see cref="KBLogger"/>.
        /// </summary>
        internal readonly string CallerFileName => GetCallerFileName();

        /// <summary>
        /// The class name of the caller who logged this log. For use by the <see cref="KBLogger"/>.
        /// </summary>
        internal readonly string CallerClassName => GetCallerClassName();
        #endregion

        /// <summary>
        /// Constructs a <see cref="KBLog"/>.
        /// </summary>
        ...
        public KBLog(string message, Object context = null, string prefix = "", KBLogLevel level = KBLogLevel.Log, Color color = default)
        {
            _message = message;
            _context = context;
            _prefix = prefix;
