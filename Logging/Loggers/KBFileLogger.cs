...
{
    /// <summary>
    /// An <see cref="IKBLogger"/> for logging to a log file.
    /// </summary>
    public class KBFileLogger : IKBLogger
    {
...
#pragma warning restore CS0414
        ...
        public IKBLogFormatter Formatter => new KBLogFormatter(formatPrefix: KBLogFormats.LongTimestampPrefix, setColor: KBLogFormats.NoColor);
